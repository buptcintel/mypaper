...
<body>
	<div style="height: 47%; margin-top: 5px;margin-left: 5px;margin-right: 5px;">
  		<table id="whgoodstable" class="easyui-datagrid"></table>
  	</div>
  	<div style="height: 40%; margin-top: 5px;margin-left: 5px;margin-right: 5px;">
  		<table id="logtable" class="easyui-datagrid"></table>
  	</div>
  	...
  	<script type="text/javascript" src="<%=path%>/public/js/whinfo.js"></script>
</body>
</html>