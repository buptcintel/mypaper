...
<head>
	...
	<script type="text/javascript" src="<%=path%>/public/js/selectlog.js"></script>
	<title>物流配送</title>
</head>
	...
	<div region="center" style="height: 90%; width:70%; margin-top: 5px;">
  	...
  	<div region="east" style="width:30%; margin-top: 5px;">
  		...
  		<div style="width: 98%;height: 46%;margin-left: 5px;margin-top: 10px;">
  			<table id="selectlog" class="easyui-datagrid"></table>
  		</div>
  	</div>
  	<div region="south" style="height:5%;">
  		<div style="height: 5%; margin-top: 5px;" align="center">
  			<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-undo'" style="width:150px" onclick="reset()">上一步</a>
  	  		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-redo'" style="width:150px" onclick="next()">物流选择确认</a>
  	  	</div>
  	</div>
